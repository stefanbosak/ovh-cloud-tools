...
# container as builder for preparing OVH cloud tools
FROM ovh-tools-builder AS ovh-tools-opentofu-builder

LABEL stage="ovh-tools-opentofu-builder" \
      description="Debian-based container builder for preparing OVH cloud tool OpenTofu CLI" \
      org.opencontainers.image.description="Debian-based container builder for preparing OVH cloud tool OpenTofu CLI" \
      org.opencontainers.image.url=https://github.com/stefanbosak/ovh-cloud-tools \
      org.opencontainers.image.source=https://github.com/stefanbosak/ovh-cloud-tools
...
# container as builder for preparing OVH cloud tools
FROM ovh-tools-builder AS ovh-tools-sofka-builder

LABEL stage="ovh-tools-sofka-builder" \
      description="Debian-based container builder for preparing OVH cloud tool sofka CLI" \
      org.opencontainers.image.description="Debian-based container builder for preparing OVH cloud tool sofka CLI" \
      org.opencontainers.image.url=https://github.com/stefanbosak/ovh-cloud-tools \
      org.opencontainers.image.source=https://github.com/stefanbosak/ovh-cloud-tools
...
COPY --from=ovh-tools-ansible-cli-builder "/usr/local/share/uv/tools" "/usr/local/share/uv/tools"
...
COPY --from=ovh-tools-sofka-builder "/usr/local/bin/" "/usr/local/bin/"
